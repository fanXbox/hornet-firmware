...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  60.0        // (Hz) The default dominant resonant frequency on the X axis.
  ...
  #define SHAPING_MAX_STEPRATE 500  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 1.60 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 1.60        // (mm) Compression length applying to all extruders
  #endif
